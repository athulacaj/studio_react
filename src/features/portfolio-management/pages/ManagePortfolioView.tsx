...
import { Box, CircularProgress, Tabs, Tab, SelectChangeEvent } from '@mui/material';
...
import { usePortfolioIframe } from '../hooks/usePortfolioIframe';
...
const ManageStudioPortfolioView: React.FC = () => {
    ...
    const { blobUrl, iframeRef, handleDataChange } = usePortfolioIframe(htmlContent, setPortfolioData);
    ...
    if (step === 1) {
        return (
            <UploadTemplateStep
                error={error}
                onNavigateBack={() => navigate('/private/studio')}
